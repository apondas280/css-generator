...
<form action="{{ route('palette.store') }}" method="post" class="mb-2">
    @csrf
    <div class="row g-2">
        <div class="col-md-9">
...
<a href="{{ route('palette') }}" class="btn btn-primary text-capitalize w-100 d-block mb-2">Update variable</a>
@foreach ($palettes as $palette)
    <a href="{{ route('palette.edit', ['mode' => $palette]) }}"
